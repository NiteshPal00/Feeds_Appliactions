...
export const UpdatesFeedsComp = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8005/getPost/${id}`)
      .then((res) => {
        console.log(res);
      })
        ...
        <Container className=" bg-black h-screen flex justify-center items-center align-middle">
          <Row className=" border-5 w-96 lg:h-96  rounded-lg border-double flex items-center ">
            <Col className="text-center ">
              <div>
                <h3 className="text-red-600 mb-3">Update your Post ! </h3>
                <Formik
                  ...
                  onSubmit={(values, { setSubmitting }) => {
                    axios
                      .put(`http://localhost:8005/updatePost/${id}`, values)
                      .then((res) => {
                        console.log(res);
                        setSubmitting(false);
                      })
